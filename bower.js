...
//endpoint is the actual syntax to find the package. Can just be the name in cases like bower registry
//But name is needed for cases like bower_component=http://github.com/bower_component.git/...
// so we can get the real name and not install to a botched URL
BowerEndpoint.prototype.download = function (endpoint, version, hash, meta, dir, name){
